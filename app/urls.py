...
urlpatterns = [
    ...
    path('projects/webs/findings/info', views.findingInfo, name='findingInfo'),
    path('projects/webs/findings/update', views.updateFinding, name='findingUpdate'),
    path('projects/webs/findings/paged', views.getPagedFindings, name='getPagedFindings'),
